...
def mobilenetv2(input, is_training, input_size=224, num_classes=3):
    with tf.variable_scope('mobilenetv2') as scope:
        ...
        return bottleneck1_2, bottleneck2_3, bottleneck4_3, bottleneck6_1
...
if __name__ == '__main__':
    ...
    with g1.as_default():
        ...
        with tf.Session() as sess:
            ...
            constant_graph = graph_util.convert_variables_to_constants(sess, sess.graph_def, ['mobilenetv2/bottleneck6_1/output'])
            with tf.gfile.FastGFile('../visualization/mobilenetv2.pb', mode='wb') as f:
