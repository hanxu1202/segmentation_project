...
def mobilenetv3_large_16s(input, is_training, input_size=224):
    with tf.variable_scope('mobilenetv3_large_16s') as scope:
        ...
        bottleneck4_1 = v3Bottleneck(name='bottleneck4_1', x=bottleneck3_6, input_channels=112, expand_channels=672,
                                     output_channels=160, rate=[2, 2], dwconv_ksize=5, nl='h_swish', is_ds=False, use_se=True,
                                     mid_channels=168, pool_size=int(input_size // 16), is_training=is_training)  # /16
...
if __name__=='__main__':
    ...
    with g1.as_default():
        ...
        output = mobilenetv3_large_16s(image, False)
